...
if(isset($_POST['btn_submit_sum']))
{
          ...
          $insert = mysqli_query($con,"INSERT INTO trb_db.tricycle_operator VALUES  (NULL, '".$first_name."', '".$middle_name ."', '".$last_name."', '".$house_no."', '".$street."', '".$barangay."', '".$city."', '".$case_no."', '".$toda."', '".$toda_no."', '".$make."', '".$motor_no."', '".$chasis_no."', '".$plate_no."', NOW() , '".$unit."');") or die(mysqli_error($con));

           $delete = mysqli_query($con,"UPDATE  trb_db.inspected set status= 0 WHERE inspected.toda_no = '".$toda_no."' ;") or die(mysqli_error($con));
