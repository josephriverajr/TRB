  ...
  <?php require('nav.php');  ?>
        ...
        <div class="container-fluid">
          <div class="d-sm-flex align-items-center justify-content-between mb-4">
            <h1 class="h3 mb-0 text-gray-800">Tricycle Regulatory Board System (Dept. Head)</h1>
          </div>
...
";
   foreach($payments as $package):
    ...
    echo "<td >".$full_add."</td>";
    echo "<td >
            <a href='or_payment.php?userid=".$package->id_no."'>Select |</a>
            <a href='../treasury/or_payment.php?userid=".$package->id_no."'>PDF </a></td>";
    echo "</tr>";
